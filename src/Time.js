...
class Time extends React.Component {
    ...
    render(){
        return(
            <>
                <h1 className="text-center text-xl text-white">Date: <span className=" font-bold">{this.state.count.toLocaleDateString()}</span> |  Time: <span className=" font-bold">{this.state.count.toLocaleTimeString()}</span></h1>
            </>
        );
    }
}
